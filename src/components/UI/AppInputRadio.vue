<template>
    <input class="catalog__category_input" v-bind:id="idAndFor" type="radio" v-bind:name="name" v-bind:checked="checked" hidden>
    <label class="catalog__category_label" v-bind:for="idAndFor">
